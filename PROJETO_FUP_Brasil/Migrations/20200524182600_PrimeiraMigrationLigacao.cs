...
{
    public partial class PrimeiraMigrationLigacao : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataTerminoCurso = table.Column<DateTime>(nullable: false),
                    Genero = table.Column<string>(maxLength: 9, nullable: false),
                    Mensalidade = table.Column<decimal>(nullable: false),
